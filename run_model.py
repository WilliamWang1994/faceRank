...
with tf.Session() as sess:
    saver.restore(sess,"E:/FaceRank/model/model.ckpt")
    step = 1
    # Keep training until reach max iterations
    # list = os.listdir("E:/FaceRank/test_resize/")
    # print(list)
    # print(len(list))
    ...
    #     score = image[0:id_tag]
            # print(score)
    img = Image.open("E:/FaceRank/test_resize/test.jpg" )
    ...
    print("Test Finished!")
    # saver.save(sess,"E:/FaceRank/model/model.ckpt")